    ...
    FoodTruck.findById(truckId)
        .then(truck => {
            ...
            res.render('dashboard/addFoodTruck', {
                ...
                closingTimeMonday: truck.openingHours[0].closingTime,
                openingTimeTuesday: truck.openingHours[1].openingTime,
                closingTimeTuesday: truck.openingHours[1].closingTime,
                openingTimeWednesday: truck.openingHours[2].openingTime,
                closingTimeWednesday: truck.openingHours[2].closingTime,
                openingTimeThursday: truck.openingHours[3].openingTime,
                closingTimeThursday: truck.openingHours[3].closingTime,
                openingTimeFriday: truck.openingHours[4].openingTime,
                closingTimeFriday: truck.openingHours[4].closingTime,
                openingTimeSaturday: truck.openingHours[5].openingTime,
                closingTimeSaturday: truck.openingHours[5].closingTime,
                openingTimeSunday: truck.openingHours[6].openingTime,
                closingTimeSunday: truck.openingHours[6].closingTime,
